...
<body>
    ...
    <form action="register.php" method="post">
        <input placeholder="ユーザー名" type="text" name="username" id="name" style="width: 370px; height: 30px">
        <br>
        <input placeholder="パスワード" type="password" name="password" id="password" style="width: 370px; height: 30px; margin-top: 15px;">
        <br>
